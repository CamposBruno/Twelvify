...
- [ ] **DEPL-01**: Express backend is deployed and running on Render with production environment variables
...
- [ ] **DEPL-04**: Extension manifest points to production Render URL (no localhost references in production build)
...
- [ ] **STOR-01**: Privacy policy is published at twelvify.com/privacy with accurate data practices
- [ ] **STOR-02**: Extension icon exists at 16, 32, 48, and 128px PNG sizes
